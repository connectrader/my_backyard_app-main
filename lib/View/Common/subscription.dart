...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
  ...
  double cardWidth(int i) {
    final length = navigatorKey.currentContext
            ?.read<UserController>()
            .productDetails
            .length ??
        0;
                ...
                builder: (context, value, child) {
                  if (value.loading) {
                    ...
                    return SingleChildScrollView(
                      child: value.productDetails.length == 1
                          ? Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: subscriptionTile(
                                  value: value,
                                  context: context,
                                  m: value.productDetails[0]),
                            )
                          : Wrap(
                              spacing: 10,
